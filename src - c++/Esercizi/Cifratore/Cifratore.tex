\exercise{Cifratore}
Implementare la classe \cod{Cifratore} con la capacità di cifrare stringhe di caratteri attraverso uno slittamento del codice ASCII dei caratteri componenti la stringa (c.d.~codice di Cesare). L'interfaccia della classe sia la seguente:
